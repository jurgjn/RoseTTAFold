...
__conda_setup="$('/hps/software/users/beltrao/jurgen/miniconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/hps/software/users/beltrao/jurgen/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/hps/software/users/beltrao/jurgen/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/hps/software/users/beltrao/jurgen/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
conda activate /hps/software/users/beltrao/jurgen/miniconda3/envs/RoseTTAFold

export PATH="/hps/software/users/beltrao/jurgen/RoseTTAFold/software/hhsuite-3.1.0-AVX2-Linux/bin:/hps/software/users/beltrao/jurgen/RoseTTAFold/software/hhsuite-3.1.0-AVX2-Linux/scripts:$PATH"
...
conda deactivate
conda activate /hps/software/users/beltrao/jurgen/miniconda3/envs/folding
